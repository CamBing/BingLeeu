...
```
QUESTIONS:
\item What exactly should be regressed? (see comment in code above). We are struggling to get the usdzar as our dependent variable. We are not sure if the zar spot should form part of the returns column, or have its own (as we have done)
